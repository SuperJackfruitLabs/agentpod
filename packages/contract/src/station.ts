import { z } from "zod";
export const Capability = z.enum(["inventory","health","logs","fs.read","fs.write","terminal","lifecycle","cleanup","acp","changeset","skills.inventory","skills.manage","skills.native","plugins.manage"]);
