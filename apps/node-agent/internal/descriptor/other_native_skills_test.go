...
func TestOtherNativePreflightsRemainClosedWithoutACPLoadingEvidence(t *testing.T) {
	...
	t.Run("opencode", func(t *testing.T) {
		...
		if err != nil || got.Ready || got.AdapterPath != binary || got.EngineVersion != "1.18.15" || !strings.Contains(got.Reason, "ACP loading") {
